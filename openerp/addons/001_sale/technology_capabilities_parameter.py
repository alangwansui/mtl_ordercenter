...
#        return [(r['label'],r['label'])for r in res]
    ...
    _get_type=[('board_type',u'板材'),('panel_size',u'拼版尺寸'),('board_thickness',u'板厚'),('min_line_width',u'最小线宽'),('min_line_space',u'最小线距'),
                ('min_hole_line',u'孔到线'),('hole_dia',u'孔径'),('cu_thickness',u'铜厚'),('tolerance',u'公差'),('td_ratio',u'厚径比')]
    
    _columns={
        'name':                   fields.char(u'名称',size=32),
#        'item':                   fields.many2one('select.selection',u'项目',domain=[('type','=','technology_capabilities')]),
        ...
        'tol_upper':              fields.float(u'正公差', digits=(6,4)),
        'tol_lower':              fields.float(u'负公差', digits=(6,4)),
        'cu_thickness':           fields.char(u'铜厚',size=32),
        ...
        'inorout':                fields.char(u'内外',size=64),
        'layer':                  fields.char(u'层数',size=64),
        'v':                      fields.char(u'基数', size=32),
